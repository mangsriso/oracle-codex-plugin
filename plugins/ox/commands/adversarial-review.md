...
- `/ox:adversarial-review` uses the same review target selection as `/ox:review`.
- It supports working-tree review, branch review, and `--base <ref>`.
- It does not support `--scope staged` or `--scope unstaged`.
- Unlike `/ox:review`, it can still take extra focus text after the flags.
...
- After launching the command, tell the user: "Codex adversarial review started in the background. Check `/ox:status` for progress."
