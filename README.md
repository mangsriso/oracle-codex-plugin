...
- `/ox:rescue`, `/ox:transfer`, `/ox:status`, `/ox:result`, and `/ox:cancel` to delegate work, hand off sessions, and manage background jobs
...
```bash
/ox:transfer
/ox:transfer --source ~/.claude/projects/-Users-me-repo/<session-id>.jsonl
```
